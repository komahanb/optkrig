...
!---- MEAN and VARIANCE OF worst OBJECTIVE FUNCTION
      ...
      !call Krigingestimate(ndimin,ndimint,xavgin,xstdin,fctin,fctindxin,nptsin,statin,fmeanout,fvarout,fmeanprimeout,fvarprimeout)

      call Krigingestimate(N,N,x,sigmax,6,0,60,0,fmeantmp,fvartmp,fmeanprimetmp,fvarprimetmp)
...
!         call Krigingestimate(ndimin,ndimint,xavgin,xstdin,fctin,fctindxin,nptsin,statin,fmeanout,fvarout,fmeanprimeout,fvarprimeout)
         ...
         call Krigingestimate(N,N,x,sigmax,6,i,60,0,fmeantmp,fvartmp,fmeanprimetmp,fvarprimetmp)
